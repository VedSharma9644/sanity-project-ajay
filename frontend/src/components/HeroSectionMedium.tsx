...
export default function HeroSectionMedium({ 
  title, 
  heading, 
  content, 
  image, 
              ...
              <div className="flex-1 w-full lg:w-1/2">
                {title && (
                  <p 
                    ...
                    className="w-full font-bold text-xs tracking-[0.2em] opacity-70 uppercase mb-4 leading-normal tracking-normal"
                  >
